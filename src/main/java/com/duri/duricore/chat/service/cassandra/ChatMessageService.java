package com.duri.duricore.chat.service.cassandra;
...
import com.duri.duricore.chat.repository.cassandra.ChatMessageByRoomRepository;
import com.duri.duricore.chat.repository.cassandra.ChatMessageBySenderRepository;
...
public class ChatMessageService {
    ...
    /**
      최근 메시지 조회
     */
    public List<ChatMessageByRoom> getRecentMessages(UUID roomId, int size) {
        ...
        List<ChatMessageByRoom> messages = new ArrayList<>(slice.getContent());
     ...
     * @return
     */
    public Slice<ChatMessageByRoom> getOlderMessages(UUID roomId, UUID beforeCreatedAt, int size) {
        return chatMessageByRoomRepository.findByKeyRoomIdAndKeyCreatedAtLessThan(
                roomId,
                beforeCreatedAt,
